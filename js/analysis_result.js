...
if (QOL_sum !== ""){
  if (QOL_sum >= 30) {
    if (ChAge < 22) {
      document.write("● 시기능이상의 자각적인 증상정도를 확인할 수 있는 QOL문진점수가 "+'<span style="font-weight: bold; color: red;">'+QOL_sum+"점"+'</span>'+"으로 독서나 학습활동, 일상생활에 지장을 줄 수 있는 "+'<span style="font-weight: bold; color: red;">'+"불편한 증상이 매우 높아 최대 학습잠재력 도달에 부정적인 영향"+'</span>'+"을 미칠 수 있습니다.<br>\n <br>\n");
    } else if (ChAge >=22 ){
      document.write("● 시기능이상의 자각적인 증상정도를 확인할 수 있는 QOL문진점수가 "+'<span style="font-weight: bold; color: red;">'+QOL_sum+"점"+'</span>'+"으로 독서나 학습활동, 일상생활에 지장을 줄 수 있는 "+'<span style="font-weight: bold; color: red;">'+"불편한 증상이 매우 높아 최대 업무수행능력 도달에 부정적인 영향"+'</span>'+"을 미칠 수 있습니다.<br>\n <br>\n");
    }
  } else if (QOL_sum >= 20 && QOL_sum <30 ) {
    if (ChAge < 22) {
      document.write("● 시기능이상의 자각적인 증상정도를 확인할 수 있는 QOL문진점수가 "+'<span style="font-weight: bold; color: red;">'+QOL_sum+"점"+'</span>'+"으로 독서나 학습활동, 일상생활에 지장을 줄 수 있는 "+'<span style="font-weight: bold; color: red;">'+"불편한 증상이 높아 최대 학습잠재력 도달에 부정적인 영향"+'</span>'+"을 미칠 수 있습니다.<br>\n <br>\n");
    } else if (ChAge >=22 ){
      document.write("● 시기능이상의 자각적인 증상정도를 확인할 수 있는 QOL문진점수가 "+'<span style="font-weight: bold; color: red;">'+QOL_sum+"점"+'</span>'+"으로 독서나 학습활동, 일상생활에 지장을 줄 수 있는 "+'<span style="font-weight: bold; color: red;">'+"불편한 증상이 높아 최대 업무수행능력 도달에 부정적인 영향"+'</span>'+"을 미칠 수 있습니다.<br>\n <br>\n");
    }
